        ...
        <div className="max-w-4xl mx-auto bg-white rounded-[2rem] md:rounded-full p-3 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 flex flex-col md:flex-row items-center gap-2 relative z-20 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300 fill-mode-both">
          ...
          <div className="flex-1 flex items-center w-full px-4 py-2 hover:bg-slate-50 rounded-full transition-colors cursor-text group">
            ...
            <div className="flex flex-col ml-3 w-full">
              <span className="text-[10px] font-bold uppercase tracking-wider text-slate-900 mb-0.5">Destination</span>
              <input 
                type="text" 
                placeholder="Where to?" 
                className="bg-transparent border-none p-0 text-sm focus:ring-0 text-slate-500 placeholder-slate-400 w-full outline-none"
              />
            </div>
          </div>
          ...
          <Button className="w-full md:w-auto h-14 rounded-full px-8 bg-slate-900 hover:bg-slate-800 text-white flex items-center justify-center gap-2 transition-luxury hover-lift mt-2 md:mt-0 shrink-0 shadow-md">
